...
{
    if(RecordData->CallbackMajorId == IRP_MJ_CREATE) {
        // 
        // get create event
        //
        fprintf(OutputFile, "get create event!!!\n");
    }
}
...
#pragma warning(pop)
        ...
        for (;;) {
            ...
            if (context->LogToScreen) {
                ...
                CheckBlackList(pRecordData, pLogRecord->Name, stdout);
            }
            ...
            if (context->LogToFile) {
                ...
                CheckBlackList(pRecordData, pLogRecord->Name, context->OutputFile);
            }
